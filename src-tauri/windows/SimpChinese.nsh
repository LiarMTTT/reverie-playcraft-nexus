...
LangString newerVersionInstalled ${LANG_SIMPCHINESE} "有一个更新版本的 ${PRODUCTNAME} 已经安装了！不推荐安装旧版本。"
LangString older ${LANG_SIMPCHINESE} "旧的"
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "系统中已存在版本为 $R4 的 ${PRODUCTNAME}。推荐先卸载当前版本后再安装。"
LangString silentDowngrades ${LANG_SIMPCHINESE} "此安装程序禁止静默降级，请使用图形界面。$\n"
...
LangString webview2AbortError ${LANG_SIMPCHINESE} "无法安装 WebView2！没有它，此应用就无法运行。请重启安装程序。"
...
LangString deleteAppData ${LANG_SIMPCHINESE} "清理桌面程序配置（工作区、历史与缓存保留）"
