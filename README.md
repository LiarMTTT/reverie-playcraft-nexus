...
![Reverie Playcraft Nexus 制卡工作台概览](./docs/assets/rpn-cover-v1.png)
...
- Agent 多协议协作：接入 OpenAI Compatible、Anthropic Messages、Google Gemini 与 Ollama Native，可监督式批准多 API 任务计划，并使用 Coding Plan、用户 Skill 和手动原生确认的 stdio MCP。
- 创意工坊：浏览和管理社区组件与二创资源。
